...
export function GradientBlob2(props: SVGPropsType) {
  return (
    <svg
      ...
      {...props}
    >
      <g opacity="0.35" filter="url(#filter0_f_9248_10254)">
        <circle cx="380.335" cy="380.335" r="179.665" fill="#D97757" />
      </g>
      <g opacity="0.4" filter="url(#filter1_f_9248_10254)">
        <circle cx="549.665" cy="380.335" r="179.665" fill="#F59E0B" />
      </g>
      <defs>
        <filter
